...
public class ActivitiTestDemo3 {
	...
	public void start() {
		...
		String userId = "666777";
		variables.put("userId", userId);
		ProcessInstance procInst = runtimeService.startProcessInstanceByKey("demo3", "train_spring", variables);
	...
	public void completeTaskVariablesTest() {
		...
		taskService.complete("192503", variables);
	}
	...
	public void findTask2() {
		Map<String, Object> variables = new HashMap<String, Object>();
		variables.put("pass", "3");

		taskService.complete("217503", variables);
		...
		((HistoryServiceImpl) historyService).getCommandExecutor().execute(new Command<String>() {
			...
			public String execute(CommandContext commandContext) {
				HistoricTaskInstanceEntity entity = commandContext.getDbSqlSession()
						.selectById(HistoricTaskInstanceEntity.class, "217503");
				entity.setOwner("黄蓉");
				entity.setDeleteReason("黄蓉  审批");
				return null;
			}
		});
	...
	public void findTask() {
		...
		for (HistoricProcessInstance his : list2) {
			System.out.println(his.getDurationInMillis() + "\t" + his.getId() + "\t" + his.getProcessDefinitionId()
					+ "\t" + his.getName());
		}
	...
	public void deleteDeployment() {
		processEngine.getRepositoryService().deleteDeployment("195001", true);
	}
}
