...
public class ActivitiTestDemo5 {
	...
	public void startByProcessInstanceByKey() {
		...
		ProcessInstance pi = processEngine.getRuntimeService()
				...
				.startProcessInstanceByKey("并行审批", variables);
	...
	public void completeTaskVariablesTest3() {
		...
		processEngine.getTaskService().complete("40004"); // act_ru_task表的主键 ID_
//		processEngine.getTaskService().complete("37508"); // act_ru_task表的主键 ID_
	}
	...
	public void downloadPNG() throws Exception {
		...
		if (!StringUtils.isEmpty(resourceName)) {
			InputStream inputStream = processEngine.getRepositoryService().getResourceAsStream(deploymentId,
					resourceName);
